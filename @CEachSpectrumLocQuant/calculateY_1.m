...
%   Peaks (K x 3 double) - experimental spectrum peaks, first column is m/z, second column is normalized intensity, third column is the true intensity obtained experimentally
% Output: 
