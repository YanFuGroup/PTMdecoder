...
%   fixedPosMod - the fixed modification [modification type-specificity-modification mass] matrix
%   dictVariMod - the variable modification [modification type-specificity-modification mass] matrix, the order is consistent with all modification types specified by the user
%   inxSites - the amino acid positions where modifications occur on the peptide, arranged in ascending order
% Output: 
%   cStr - IMP strings, which is a column cell array,
