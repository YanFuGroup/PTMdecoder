...
CIMPQuantStats.quant_group_stats('record', diagnostics.reason);
if ~has_nonzero_imp
    CLogger.debug(['[CIMPProcessingExecutor:onGroupQuant] Skipped group. raw=%s, charge=%d, ', ...
        'imps=%s, reason=%s, candidate_nonzero_points=%s, min_xic_nonzero_points=%d.'], ...
        group.rawName, group.selectedCharge, strjoin(group.impNames, ';'), diagnostics.reason, ...
        mat2str(diagnostics.candidate_nonzero_points'), diagnostics.min_nonzero_points);
end
