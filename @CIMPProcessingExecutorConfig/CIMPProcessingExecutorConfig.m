    ...
    methods
        function obj = CIMPProcessingExecutorConfig(cfg)
            ...
            if nargin < 1 || ~isstruct(cfg)
                CLogger.error(['[CIMPProcessingExecutorConfig:InvalidConstructorArgs] ', ...
    ...
    methods (Static, Access = private)
        function cfg = finalize(cfg)
            ...
            if isempty(cfg.ms12DatasetIO)
                CLogger.error(['[CIMPProcessingExecutorConfig:InvalidMs12DatasetIO] ', ...
            ...
            if isempty(cfg.ms1_tolerance) || ~isstruct(cfg.ms1_tolerance) || ...
                ...
                CLogger.error(['[CIMPProcessingExecutorConfig:InvalidMs1Tolerance] ', ...
            ...
            if ~isscalar(cfg.minXicNonzeroPoints) || ~isnumeric(cfg.minXicNonzeroPoints) || ...
                ...
                CLogger.error(['[CIMPProcessingExecutorConfig:InvalidMinXicNonzeroPoints] ', ...
