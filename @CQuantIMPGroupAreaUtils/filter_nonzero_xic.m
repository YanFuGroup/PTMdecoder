function [imp_idx_nonzero, area_imp_final, xic_peak_rt_bounds, varargout] = filter_nonzero_xic(area_imp_final, xic_peak_rt_bounds, varargin)
...
%   xic_peak_rt_bounds (M x P struct)
%       RT bounds per IMP per peak, fields: .rt_start/.rt_end (minutes)
%   varargout
...
xic_peak_rt_bounds = xic_peak_rt_bounds(imp_idx_nonzero,:);
