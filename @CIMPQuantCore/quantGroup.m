...
if ~isnumeric(minXicNonzeroPoints) || ~isscalar(minXicNonzeroPoints) || ...
        ~isfinite(minXicNonzeroPoints) || minXicNonzeroPoints < 1 || ...
        floor(minXicNonzeroPoints) ~= minXicNonzeroPoints
    error('CIMPQuantCore:InvalidMinXicNonzeroPoints', ...
