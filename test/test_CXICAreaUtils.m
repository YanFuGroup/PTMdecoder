classdef test_CXICAreaUtils < matlab.unittest.TestCase
    ...
    methods (Test)
        function testComputeFinalArea(testCase)
            ...
            area_imp_final = CXICAreaUtils.compute_final_area(...
        ...
        function testFilterNonzeroXic(testCase)
            ...
            [imp_idx_nonzero, area_imp_final_f, xic_peak_rt_bounds_f, extra_numeric_f, extra_empty_f] = ...
                CXICAreaUtils.filter_nonzero_xic(area_imp_final, xic_peak_rt_bounds, extra_numeric, extra_empty);
