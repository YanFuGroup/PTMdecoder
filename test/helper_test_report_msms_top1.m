function helper_test_report_msms_top1(projectRootDir, testDataDir, outputDir)
% HELPER_TEST_REPORT_MSMS_TOP1 Runs the report_msms_top1 generation test case
% Input:
...
%   (none)
    ...
    % --- Configuration ---
    result_dir = fullfile(outputDir, 'report_msms_top1');
    input_dir = fullfile(testDataDir, 'report_msms_top1');
    ...
    fileName = fullfile(result_dir,'report_msms_top1.txt');
